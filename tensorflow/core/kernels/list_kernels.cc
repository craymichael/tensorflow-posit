...
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_CPU(posit8);
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_CPU(posit16);
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_CPU(posit32);
...
REGISTER_TENSOR_LIST_STACK_CPU(posit8);
REGISTER_TENSOR_LIST_STACK_CPU(posit16);
REGISTER_TENSOR_LIST_STACK_CPU(posit32);
...
REGISTER_TENSOR_LIST_FROM_TENSOR_CPU(posit8);
REGISTER_TENSOR_LIST_FROM_TENSOR_CPU(posit16);
REGISTER_TENSOR_LIST_FROM_TENSOR_CPU(posit32);
