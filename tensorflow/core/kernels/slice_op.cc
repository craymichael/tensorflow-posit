...
TF_CALL_posit8(DECLARE_FOR_N);
TF_CALL_posit16(DECLARE_FOR_N);
TF_CALL_posit32(DECLARE_FOR_N);
DECLARE_FOR_N(int32);
...
TF_CALL_posit8(REGISTER_GPU);
TF_CALL_posit16(REGISTER_GPU);
TF_CALL_posit32(REGISTER_GPU);
