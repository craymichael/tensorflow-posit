...
REGISTER_TENSOR_LIST_STACK_GPU(posit8);
REGISTER_TENSOR_LIST_STACK_GPU(posit16);
REGISTER_TENSOR_LIST_STACK_GPU(posit32);
...
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_GPU(posit8);
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_GPU(posit16);
REGISTER_TENSOR_LIST_PUSH_BACK_BATCH_GPU(posit32);
...
REGISTER_TENSOR_LIST_FROM_TENSOR_GPU(posit8);
REGISTER_TENSOR_LIST_FROM_TENSOR_GPU(posit16);
REGISTER_TENSOR_LIST_FROM_TENSOR_GPU(posit32);
