...
TF_CALL_posit8(DEFINE_GPU_KERNELS);
TF_CALL_posit16(DEFINE_GPU_KERNELS);
TF_CALL_posit32(DEFINE_GPU_KERNELS);
...
TF_CALL_posit8(REGISTER_GPU_KERNEL);
TF_CALL_posit16(REGISTER_GPU_KERNEL);
TF_CALL_posit32(REGISTER_GPU_KERNEL);
