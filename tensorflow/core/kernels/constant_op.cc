...
REGISTER_KERNEL(GPU, posit8);
REGISTER_KERNEL(GPU, posit16);
REGISTER_KERNEL(GPU, posit32);
...
REGISTER_KERNEL(posit8, GPU);
REGISTER_KERNEL(posit16, GPU);
REGISTER_KERNEL(posit32, GPU);
