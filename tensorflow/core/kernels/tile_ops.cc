...
#define HANDLE_TYPE_NAME(T) HANDLE_TYPE(DataTypeToEnum<T>::value)
    ...
    TF_CALL_posit8(HANDLE_TYPE_NAME);
    TF_CALL_posit16(HANDLE_TYPE_NAME);
    TF_CALL_posit32(HANDLE_TYPE_NAME);
...
TF_CALL_posit8(HANDLE_TYPE_NAME_CPU);
TF_CALL_posit16(HANDLE_TYPE_NAME_CPU);
TF_CALL_posit32(HANDLE_TYPE_NAME_CPU);
